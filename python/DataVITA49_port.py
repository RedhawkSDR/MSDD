...
from bulkio import BULKIO, OutVITA49Port
    
class PortBULKIODataVITA49Out_implemented(OutVITA49Port):
...
class PortBULKIODataVITA49OutFFT_implemented(PortBULKIODataVITA49Out_implemented):
    def connectPort(self, connection, connectionId):
        self.parent.register_fft_connection(connectionId)
        PortBULKIODataVITA49Out_implemented.connectPort(self, connection, connectionId)
        
    def disconnectPort(self, connectionId):
        self.parent.deregister_fft_connection(connectionId)
        PortBULKIODataVITA49Out_implemented.disconnectPort(self, connectionId)
